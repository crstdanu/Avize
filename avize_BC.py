...
def aviz_APM(id_lucrare, path_final):
    ...
    model_Notificare_APM = (
        r"G:\Shared drives\Root\11. DATABASE\01. Automatizari avize\MODELE\BC\01.Mediu APM\02.Notificare.docx")
...
def aviz_EE_Delgaz(id_lucrare, path_final):
    ...
    model_email = (
        'G:/Shared drives/Root/11. DATABASE/01. Automatizari avize/MODELE/BC/02.Aviz EE Delgaz/'f"Model email{' - DELGAZ' if y['lucrare']['IDClient'] == 1 else ''}.docx")
...
def aviz_Orange(id_lucrare, path_final):
    ...
    x.copy_file("G:/Shared drives/Root/11. DATABASE/01. Automatizari avize/MODELE/BC/07.Aviz Orange/Citeste-ma.docx",
...
def aviz_HCL(id_lucrare, path_final):
    ...
    path_document_final = os.path.join(
        path_final, director_final, f"Documentatie aviz HCL  - {y['client']['nume']} conform CU nr. {y['lucrare']['nr_cu']} din {y['lucrare']['data_cu']}.pdf.pdf")
...
def aviz_Orange(id_lucrare, path_final):
    director_final = '07.Aviz Orange - Bacau'
    y = x.get_data(path_final, director_final, id_lucrare)
...
def aviz_MApN(id_lucrare, path_final):
    ...
    x.copy_file(y['lucrare']['CalePlanSituatiePDF'], path_final, director_final, 'Plan situatie.pdf')
